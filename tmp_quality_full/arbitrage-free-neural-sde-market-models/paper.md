...
page_count: 47
extracted_at: "2026-02-07T05:34:30.190551+00:00"
status: "success"
---
...
<table>
  <tr>
    <th>Heston-SLV model Simulation</th>
  </tr>
  <tr>
    <td>θ κ σ ρ L (cid:19)t N rt qt</td>
  </tr>
  <tr>
    <td>Parameter S0 ν0</td>
  </tr>
  <tr>
    <td>Value 0 0 100 0.0083 0.0085 8.3 0.32 −0.42 10,000 0.0001 46</td>
  </tr>
  <tr>
    <td>a local volatility component, the so-called leverage function L. Here, the subscript t of L</td>
  </tr>
  <tr>
    <td>indicates that calibration of L is performed from derivative prices observed at t. The cal-</td>
  </tr>
  <tr>
    <td>ibration typically involves an initial optimization of the fit over the Heston parameters,</td>
  </tr>
  <tr>
    <td>followed by a calibration of the leverage function using Markovian projections (see Piter-</td>
  </tr>
  <tr>
    <td>barg 2006 for a review of early approaches and the references in Bain, Mariapragassam,</td>
  </tr>
  <tr>
    <td>and Reisinger (2021) for more recent contributions).</td>
  </tr>
  <tr>
    <td>We obtain the parameters and the leverage function used for generating synthetic input</td>
  </tr>
  <tr>
    <td>data in our tests by calibrating a Heston-SLV model to Bloomberg OTC USDBRL option</td>
  </tr>
  <tr>
    <td>price data on 28th October 2008, using the QuantLib library (Quantlib 2021). The Heston</td>
  </tr>
  <tr>
    <td>parameters are listed in Table 1, and we plot the leverage function L in Figure 7.</td>
  </tr>
  <tr>
    <td>We simulate discrete time series data for S, ν and call options with N fixed values of</td>
  </tr>
  <tr>
    <td>moneyness and maturity, over a time period of (L + 1)(cid:19)t (see Table 1 for the values used).</td>
  </tr>
  <tr>
    <td>These values are chosen to broadly emulate the observation, at moderate frequency (of</td>
  </tr>
  <tr>
    <td>the order of every 10 minutes), of a single year’s prices for the underlying asset and liquid</td>
  </tr>
  <tr>
    <td>European options book. Here, a single path of (S, ν) is sampled by an Euler–Maruyama</td>
  </tr>
  <tr>
    <td>∗</td>
  </tr>
  <tr>
    <td>approximation to (30) on [0, T ] ,7 and, for each t, option values at(S t, νt) are produced</td>
  </tr>
  <tr>
    <td>using the calibrated Heston parameters and the initial portion, i.e., Lt(u, ·) = L0(u − t, ·),</td>
  </tr>
  <tr>
    <td>u ∈ (t, T ∗).8</td>
  </tr>
  <tr>
    <td>This step is only required to generate the simulated input data, but not when real mar-</td>
  </tr>
  <tr>
    <td>ket data are used. The SDE (30) is formulated in the risk-neutral measure used for pricing</td>
  </tr>
  <tr>
    <td>options for each t, started at(S t, νt) along the chosen trajectory. We also use (30) for gen-</td>
  </tr>
  <tr>
    <td>erating the (St, νt) trajectory on [0, T]. Here, any drift could be used, and we choose 0 for</td>
  </tr>
  <tr>
    <td>simplicity, but note that this does not imply simulation under the risk-neutral measure.9</td>
  </tr>
</table>
...
*Caption:* Table 2. MAPE, PDA and PSAS metrics when including diﬀerent
...
![Figure 19: Figure 1. The quoted strikes/log-moneynesses/Black–Scholes deltas (horizontal axis) for all expiries (vertical axis) of CME weekly- and monthly-listed EURUSD European call options as of 31st May 2018. Each dot represents a market quote.](assets/fig_019.png)

![Figure 20: Figure 2. An example of the trajectory of (τt, mt) for ﬁxed (T, K)’s. Grey dots indicate the traded strikes forCMEEURUSDoptioncontractswithexpirydate6thMarch2020,fromtheirﬁrstlistingdayuntilexpiry. We highlight the trajectories for three diﬀerently struck contracts.](assets/fig_020.png)

![Figure 21: Figure 4. Constrained neural network.](assets/fig_021.png)

![Figure 22: Figure 5. Orthogonaldirectionsforshrinkingthediﬀusionfunction.Asy isclosertoboundary4(bottom right) than the others, direction q1 points to this boundary, and will be shrunk the most by the linear shrinking matrix P(y).](assets/fig_022.png)

![Figure 23: Figure 6. An example of ρ∗-interior points for calculating drift correction directions.](assets/fig_023.png)

![Figure 24: Figure 7. The leverage function L(t, S) of the Heston-SLV model used for simulation.](assets/fig_024.jpeg)

![Figure 25: Figure 7. The leverage function L(t, S) of the Heston-SLV model used for simulation.](assets/fig_025.jpeg)

![Figure 26: Figure 7. The leverage function L(t, S) of the Heston-SLV model used for simulation.](assets/fig_026.jpeg)

![Figure 27: Figure 8. Partial derivatives of the normalized call price surface approximated by interpolation at t = 0.](assets/fig_027.jpeg)

![Figure 28: Figure 8. Partial derivatives of the normalized call price surface approximated by interpolation at t = 0.](assets/fig_028.jpeg)

![Figure 29: Figure 8. Partial derivatives of the normalized call price surface approximated by interpolation at t = 0.](assets/fig_029.jpeg)

![Figure 30: Figure 9. Price basis functions of the normalized call price surface.](assets/fig_030.jpeg)

![Figure 31: Figure 9. Price basis functions of the normalized call price surface.](assets/fig_031.jpeg)

![Figure 32: Figure 9. Price basis functions of the normalized call price surface.](assets/fig_032.jpeg)

![Figure 33: Figure 9. Price basis functions of the normalized call price surface.](assets/fig_033.jpeg)

![Figure 34: Figure 11. Evolution of training losses and validation losses.](assets/fig_034.png)

![Figure 35: Figure 12. Estimated drift and diﬀusion coeﬃcients for S. (a) Scattergrams of φS,μ σ (˜ξtl) against S, ξ1 and ξ2. The estimated drift φS,μ σ (˜ξtl) has values around 0, the ground-truth drift. (b) Scattergram of φS,θ σ (˜ξtl) against σ S t .](assets/fig_035.png)

![Figure 36: Figure 13. The linear relationship between ξ1 and ν.](assets/fig_036.png)

![Figure 37: Figure 14. Comparison of the estimated drift and diﬀusion functions and the (approximated) groundtruth drift and diﬀusion functions for ξ1.](assets/fig_037.jpeg)

![Figure 38: Figure 14. Comparison of the estimated drift and diﬀusion functions and the (approximated) groundtruth drift and diﬀusion functions for ξ1.](assets/fig_038.jpeg)

![Figure 39: Figure 16. Simulation of S and ξ from the learnt neural network model, compared with the Heston-SLV](assets/fig_039.png)

![Figure 40: Figure 16. Simulation of S and ξ from the learnt neural network model, compared with the Heston-SLV](assets/fig_040.png)

![Figure 41: Figure 16. Simulation of S and ξ from the learnt neural network model, compared with the Heston-SLV](assets/fig_041.png)

![Figure 42: Figure 16. Simulation of S and ξ from the learnt neural network model, compared with the Heston-SLV](assets/fig_042.png)

![Figure 43: Figure 16. Simulation of S and ξ from the learnt neural network model, compared with the Heston-SLV](assets/fig_043.png)

![Figure 44: Figure 19. Joint distribution of the log-return of S and the VIX-like volatility index. (a) Heston-SLV VIX v.s. VIX calculated from the simulated option prices. (b) Heston-SLV VIX v.s. VIXr calculated from the regression model on the simulated factors.](assets/fig_044.png)
...
- discarded low-quality embedded figure on page 32: score=0.00, flags=small_area,small_edge,extreme_aspect_ratio,small_payload,caption_nearby
- discarded low-quality embedded figure on page 32: score=0.00, flags=small_area,small_edge,extreme_aspect_ratio,caption_nearby
- discarded low-quality embedded figure on page 33: score=0.02, flags=small_area,small_edge,small_payload,caption_nearby
- discarded low-quality embedded figure on page 33: score=0.02, flags=small_area,small_edge,small_payload,caption_nearby
- discarded low-quality embedded figure on page 33: score=0.02, flags=small_area,small_edge,small_payload,caption_nearby
- discarded low-quality embedded figure on page 33: score=0.02, flags=small_area,small_edge,small_payload,caption_nearby
- discarded low-quality embedded figure on page 46: score=0.15, flags=small_area,small_payload
- discarded low-quality embedded figure on page 46: score=0.25, flags=small_edge,small_payload
- discarded low-quality embedded figure on page 46: score=0.25, flags=small_edge,small_payload
- discarded low-quality embedded figure on page 46: score=0.00, flags=small_edge,extreme_aspect_ratio,small_payload
- discarded low-quality embedded figure on page 46: score=0.25, flags=small_edge,small_payload
- discarded low-quality embedded figure on page 46: score=0.25, flags=small_edge,small_payload
- discarded low-quality embedded figure on page 46: score=0.00, flags=small_area,small_edge,extreme_aspect_ratio,small_payload
